...
## Version 3.8.3 (2025-04-21)

### Changed
- Remove Instagram vom social media comparison (scraping does not work anymore)
- Update libraries


## Version 3.8.2 (2023-10-03)

### Changed
- Remove Twitter from social media comparison (API requires paid account now)
- Update libraries
- Use latest version of Facebook's Graph API


## Version 3.8.1 (2021-12-04)

### Fixed
- Fix weekday names in follower charts (German translation only)
